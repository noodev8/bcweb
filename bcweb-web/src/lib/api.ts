...
// The business as a portfolio of earning assets. The screen reads the STORED status tags (GET /portfolio-status, below); the
// live winner count (GET /portfolio-winners), its trend and the Contenders model were removed 2026-09-25, so every "winners"
// number is the tag.

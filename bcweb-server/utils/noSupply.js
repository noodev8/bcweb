...
=======================================================================================================================================
Purpose: "CAN'T GET IT" — the supplier has none of a style, so it is hidden from the ORDER SCREENS until a re-check day, then comes
         back on its own (owner, 2026-09-26). For ordering this is THE availability test — season no longer is ("for ordering, I should
         use Can't get / Release as the de facto").

         ON SCREEN THE PAIR IS "CAN'T GET" / "RELEASE" — never park/unpark: "parked" already means a style's pricing review date on
         Repricing, and one word for two things on the same style is the confusion to avoid. (In this code "park" survives only as an
...
back early is handled by releasing it (on the order screen, or on the Can't get view on Seasons).

NOTHING ELSE CHANGES when it is set: not the season, not the status, not the Repricing lists on either channel. "I can't buy any more, but I can price
what I do have."
=======================================================================================================================================
*/

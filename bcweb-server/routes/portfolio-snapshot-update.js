...
WHAT A SNAPSHOT MEANS, AND WHY IT IS NOT JUST A CACHE
         ...
         ⚠ THE BAR IS NOT STORED WITH THE ROW. Every count is taken against WINNER_PROFIT_BAR / MATURITY_DAYS as they stood on the
           ...
           A screen control for the bar was built and removed on 2026-09-22 (see WINNER_BAR_LADDER). Should the idea return, the
           rule is this route's, not the screen's: one series, one ruler, or the trend is a lie. Never add a bar parameter here.
